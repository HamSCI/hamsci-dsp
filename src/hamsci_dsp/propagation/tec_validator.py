...
from hamsci_dsp.propagation.tec_geometry import (
...
# Station table from the frozen catalog (split §5.2 DI seam).
STATION_LOCATIONS = BUILTIN_CATALOG.locations()
...
class TECValidator:
    ...
    def __init__(self, ionex_dir: Optional[Path] = None):
        ...
        """
        # DI (split §5.2): no client-path default; None flows through to
        # IonosphericModel, which treats it as IONEX-disabled.
