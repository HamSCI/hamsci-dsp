...
- hamsci_dsp.stations — station locations (frozen catalog)
"""
...
from hamsci_dsp.geometry import hop_geometry, max_single_hop_distance_km
...
class HFPropagationModel:
    ...
    def _get_iono_service(self):
        ...
        if self._iono_service is None and self.enable_realtime:
            try:
                from hamsci_dsp.ionosphere.data_service import IonoDataService
